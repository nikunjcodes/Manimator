...
import { AnimationGenerator } from '@/components/animation/animation-generator'
import { AnimationList } from '@/components/animation/animation-list'
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800">
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs defaultValue="animations" className="space-y-6">
          <TabsList className="bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm">
          ...
          <TabsContent value="animations" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-6">
                <AnimationGenerator onAnimationComplete={handleAnimationComplete} />
                {selectedAnimationId && (
                  <AnimationPlayer
                    animationId={selectedAnimationId}
                    onClose={() => setSelectedAnimationId(null)}
                  />
                )}
              </div>
              <div>
                <AnimationList onAnimationSelect={setSelectedAnimationId} />
              </div>
            </div>
          </TabsContent>
